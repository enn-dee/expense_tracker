...
const AddTransaction = () => {
    ...
    return (
        <div className="grid place-items-center gap-2 my-8">
            ...
            <form action={clientAction} className=" w-80 mx-auto p-2 rounded-md shadow-md border border-black/20 flex flex-col gap-2 backdrop-blur-md bg-gradient-to-br from-blue-300/30 to-red-200/30">
